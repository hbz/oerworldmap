  ...
  var my = {
    ...
    attach : function(context) {
        ...
        .each(function()
      {
        ...
        $('<span class="small" data-action="add">+ ' + i18nStrings['ui']['resourceFormWidgets.localizedInput.addLanguage'] + '</span>')
          .appendTo(widget)
          .click(function(){
    ...
    initOne : function(one) {
      ...
      var button_text = current_language_code ? i18nStrings["iso639-1"][ current_language_code ] : i18nStrings['ui']['resourceFormWidgets.localizedInput.language'];
